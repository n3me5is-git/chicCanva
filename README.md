...
- `clipart*`: explorer Openclipart e traduzione;
...
Il service worker deve rimanere nello stesso percorso dell'app per conservarne lo scope. Una Content Security Policy rigida deve consentire script/stili inline o usare hash generati, Blob Worker, Data/Blob image, Puter, provider font, OpenMoji, Openclipart, MyMemory e `staticimgly.com`. Le istruzioni operative complete sono in [Deploy](docs/DEPLOYMENT.md).
