...
before('startCropBtn','<button class="btn pdf-import-button" id="importPdfBtn">Importa PDF come immagini</button><input id="pdfFile" type="file" accept="application/pdf,.pdf" hidden>'+(dev/'memory-ui.html').read_text(encoding='utf-8'))
...
rep('<div><label class="small">Snap mm</label><input class="field" id="snapSpacing" type="number" min="0.5" max="100" step="0.5" value="5"></div>','<div><label class="small">Snap mm</label><input class="field" id="snapSpacing" type="number" min="0.5" max="100" step="0.5" value="5"></div><div><label class="small">Rotazione a scatti</label><div class="rotation-step-field"><input class="field" id="snapRotationStep" type="number" min="1" max="90" step="1" value="10"><span>°</span></div></div>')
