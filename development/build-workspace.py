...
rep('<label class="small">Rimozione sfondo</label>',(dev/'image-effects.html').read_text(encoding='utf-8')+'<label class="small">Rimozione sfondo</label>')
